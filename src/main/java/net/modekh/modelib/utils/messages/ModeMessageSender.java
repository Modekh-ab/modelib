...
public enum ModeMessageSender implements IMessageSender {
    ...
    NOTIFICATION_SYSTEM(Component.translatable("message.cheaks.sender.notification"), "gold"),
    NOTIFICATION_SYSTEM_AQUA(Component.translatable("message.cheaks.sender.notification"), "aqua");
